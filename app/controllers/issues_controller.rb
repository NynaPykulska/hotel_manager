class IssuesController < ApplicationController
	...
	def create
      ...
      start_date =  DateTime.new(params[:issue]["start_date(1i)"].to_i, params[:issue]["start_date(2i)"].to_i ,params[:issue]["start_date(3i)"].to_i)
      end_date =    DateTime.new(params[:issue]["end_date(1i)"].to_i, params[:issue]["end_date(2i)"].to_i ,params[:issue]["end_date(3i)"].to_i)
